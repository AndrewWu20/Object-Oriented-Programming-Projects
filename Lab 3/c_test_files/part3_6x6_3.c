...
void test_part3_6x6_3(){
	...
	sBoard.movePiece(0,2,5,3);
	sBoard.movePiece(2,0,3,1);
	sBoard.movePiece(1,3,4,3);
	sBoard.movePiece(5,3,5,2);
	sBoard.movePiece(4,3,1,3);
	sBoard.movePiece(3,4,5,5);
	...
	sBoard.movePiece(4,0,4,1);
	sBoard.movePiece(5,1,5,0);
	sBoard.movePiece(2,1,3,1);
	sBoard.movePiece(2,4,4,5);
